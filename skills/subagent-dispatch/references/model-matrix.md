...
- **A tier change here is a pipeline change.** `complete-review` delegates its real work to `code-review`/`tests-code-review`; retiering one without the others leaves the stack inconsistent. Change the rows together.

...
Agent
  ...
  prompt: |
    ...
    5. Run this PR's own Jira Ticket Sync, independently of every other PR's subagent:
       ...
       before step 2's fixing work begins, then a completion comment after it finishes

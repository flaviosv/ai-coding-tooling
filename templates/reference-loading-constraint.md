...
description: Constraint for loading only stack-relevant reference files based on docs/codebase/PROJECT_DETAILS.md tech stack detection.
type: template
---

> **CONSTRAINT: Load ONLY stack-relevant references.**
> Detect the tech stack from `docs/codebase/PROJECT_DETAILS.md` (fall back to `docs/PROJECT_DETAILS.md` if not yet migrated). Reference files use the naming convention
...
> `golang-code-review.md`, `php-code-review.md`, etc. If `docs/codebase/PROJECT_DETAILS.md` (or the legacy `docs/PROJECT_DETAILS.md`) is missing or

...
description: Constraint for loading only stack-relevant reference files based on docs/codebase/STACK.md tech stack detection.
type: template
---

> **CONSTRAINT: Load ONLY stack-relevant references.**
> Detect the tech stack from `docs/codebase/STACK.md` (fall back to `.specs/codebase/STACK.md`, then legacy `docs/codebase/PROJECT_DETAILS.md` / `docs/PROJECT_DETAILS.md`). Reference files use the naming convention
...
> `golang-code-review.md`, `php-code-review.md`, etc. If `docs/codebase/STACK.md` (or the fallbacks `.specs/codebase/STACK.md` / legacy `docs/codebase/PROJECT_DETAILS.md` / `docs/PROJECT_DETAILS.md`) is missing or
